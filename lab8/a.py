...
background = pygame.image.load("/Users/rgalbekovaaltynai/Documents/GitHub/sem2/lab9/AnimatedStreet.png")
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("/Users/rgalbekovaaltynai/Documents/GitHub/sem2/lab9/Enemy.png")
...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("/Users/rgalbekovaaltynai/Documents/GitHub/sem2/lab9/coin.png")
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("/Users/rgalbekovaaltynai/Documents/GitHub/sem2/lab9/Player.png")
        self.rect = self.image.get_rect()
        self.rect.center = (160, 520)
    def gr(self):
        if self.rect.centerx > SCREEN_WIDTH-40 or self.rect.centerx < 40:
            return False
        return True
